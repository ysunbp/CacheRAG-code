...
def cacherag(question_set, wikisp_generator, wikisp_tokenizer, generator, out_path, relation2link_dict, openai_client, dpr_one_hop = 10):
    ...
    random.seed(20)
    indices = random.sample(range(len(questions)), 375)
...
if __name__ == "__main__":
    ...
    cur_model_dir = "/export/data/ysunbp/KBQA/kgretrival/baselines/wikidata-emnlp23/trained_model"
    ...
    with open('./QALD-10/questions.pkl', 'rb') as file:
        questions = pickle.load(file)
    with open('./QALD-10/wiki_answers.pkl', 'rb') as file:
        wiki_answers = pickle.load(file)
    with open('./QALD-10/types.pkl', 'rb') as file:
    ...
    outpath = "./json/qald-cacherag-autogen.json"
