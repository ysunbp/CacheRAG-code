...
from planner_cot import ZERO_SHOT_PLANNER_TEMPLATE, COT_TEMPLATE_FOR_DATE
...
def get_ticker_name_list(file_path='../mockapi/crag-mock-api/cragkg/finance/company_name.dict'):
    ticker_list = []
...
planner_res_path = '../results/time_extracted.json'
kg_res_path = '../results/kg_preprocessed.json'
