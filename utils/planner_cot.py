...
2) Extract structured information from the query. Include different keys into the result json depending on the domains, amd put them DIRECTLY in the result json. Importance is determined by the grammatical function and semantic role of words within the sentence. Here are the rules:
